<script lang="ts">
        ...
        // Server-validated by +layout.server.ts (admins table + is_admin RPC).
        $: isLoggedIn = $page.data?.isAdmin ?? false;

        function handleLogout() {
                goto('/admin/login');
                // actual sign-out is handled by the shared layout topbar.
        }
</script>
        ...
        <div class="admin-home">
                <header class="admin-header">
                        <div class="header-content">
                                <h1>Admin Panel</h1>
                                <button type="button" on:click={handleLogout} class="logout-btn">Logout</button>
                        </div>
                </header>
							...
							<p>Manage social feed posts (manual + Graph API sync)</p>
                                ...
                                <div class="info-section">
                                        ...
                                        <div class="help-items">
                                                ...
                                                <div class="help-item">
                                                        <strong>Documentation:</strong> <a href="https://github.com/Roy-Wanyoike/New-Delima-Realtors#readme" target="_blank" rel="noopener noreferrer">Read full guide</a>
                                                </div>
                                        </div>
                                </div>
                        </div>
